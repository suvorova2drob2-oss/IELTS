  ...
  panels: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          id: "8-1",
          stem: "The bar chart gives the percentage of passenger cars manufactured by different regions of the world. ______, the world is divided into seven regions, with the total adding up to 100%.",
          key: "For the purposes of this data set",
        },
        {
          id: "8-2",
          stem: "______ that the regions of Greater China and Europe lead the way",
          key: "What stands out is",
        },
        {
          id: "8-3",
          stem: "… lead the way ______ the manufacture of passenger cars, with 26% and 25%",
          key: "in terms of",
        },
        {
          id: "8-4",
          stem: "… with 26% and 25% ______.",
          key: "respectively",
        },
        {
          id: "8-5",
          stem: "______, very few cars are produced in the Middle East and Africa: just 2% originate from that area.",
          key: "By contrast",
        },
        {
          id: "8-6",
          stem: "______ the Americas, a sharp contrast can be seen between the Northern and Southern parts of the continent.",
          key: "Turning next to",
        },
        {
          id: "8-7",
          stem: "______ North America can boast 19% of the world's passenger car production, South America manufactures just 4%.",
          key: "Whereas",
        },
        {
          id: "8-8",
          stem: "Finally, ______ Japan and Korea,",
          key: "moving on to",
        },
        {
          id: "8-9",
          stem: "… Japan and Korea, ______ they are just two countries rather than a whole region, they account for a sizeable proportion of the total, at 16%.",
          key: "although",
        },
      ],
    },
