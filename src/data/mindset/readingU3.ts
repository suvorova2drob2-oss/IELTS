  ...
  steps: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "3", stem: "Q3", options: [{ id: "T", text: "True" }, { id: "F", text: "False" }, { id: "NG", text: "Not Given" }], key: "NG" },
        { id: "4", stem: "Q4", options: [{ id: "T", text: "True" }, { id: "F", text: "False" }, { id: "NG", text: "Not Given" }], key: "T" },
        { id: "5", stem: "Q5", options: [{ id: "T", text: "True" }, { id: "F", text: "False" }, { id: "NG", text: "Not Given" }], key: "T" },
        { id: "6", stem: "Q6", options: [{ id: "T", text: "True" }, { id: "F", text: "False" }, { id: "NG", text: "Not Given" }], key: "F" },
        {
          id: "7",
          stem: "Q7 — Rodin / casting technique (correct option)",
          options: [
            { id: "A", text: "A" },
            { id: "B", text: "B" },
            { id: "C", text: "C" },
            { id: "D", text: "D — repeatedly casting the same figure / multiple casts" },
          ],
          key: "D",
        },
        {
          id: "8",
          stem: "Q8 — pioneering forms of sculpture",
          options: [
            { id: "A", text: "A" },
            { id: "B", text: "B" },
            { id: "C", text: "C" },
        ...
        {
          id: "9",
          stem: "Q9 — modern gallery experience (touch / participation)",
          options: [
            { id: "A", text: "A" },
            { id: "B", text: "B" },
            { id: "C", text: "C — Touch, physical participation and social interaction…" },
            { id: "D", text: "D" },
          ],
          key: "C",
        },
