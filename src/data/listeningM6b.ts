...
export function checkListenM6b(input: string, accepted: string[]): boolean {
  const n = normalize(input);
  if (!n) return false;
  return accepted.some((a) => normalize(a) === n);
}

export const listeningM6b = {
  id: "listening-m6b-flow",
  bookPages: "p. 95 in your coursebook",
  sectionTitle: "Listening · Section 4 (super recognisers)",
  noAudioNote:
    "Аудио пока нет — можно пройти подготовку и exam. Ключи: 1A 2A 3B 4C · 5 software · 6 low quality · 7 changing · 8 humans · 9 holistically · 10 cameras.",
  before: {
    badge: "1",
