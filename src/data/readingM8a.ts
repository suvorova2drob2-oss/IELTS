...
export function checkReadM8a(input: string, accepted: string[]): boolean {
  const n = normalize(input);
  if (!n) return false;
  return accepted.some((a) => normalize(a) === n);
}

export const readingM8a = {
  id: "reading-m8a-flow",
  bookPages: "pp. 120–121 in your coursebook",
  sectionTitle: "Reading · Yes/No/Not given; Multiple choice (select two)",
  title: "Altruism and the biology of kindness",
  subtitle:
  ...
  exam: {
    ...
    instruction:
      "Yes/No/Not given + Multiple choice (select two). TB keys: 1 No  2 No  3 Not given  4 Yes  5 Yes  6/7 A; E. Fact: 1,4,11 · Opinion: 2,3,5–10,12,13 · Opinion language: 5,6,7,8,10.",
