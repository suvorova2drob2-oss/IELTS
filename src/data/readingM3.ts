...
export const readingM3 = {
  ...
  beforeYouRead: {
    ...
    suggestedAnswer: [
      "From my perspective, many people’s lives are more stressful now than in the past, largely because of constant digital communication and long working hours. To begin with, smartphones make it harder to switch off, so work emails and social media often interrupt rest time.",
      "Moreover, urban living can intensify pressure: longer commuting times, higher living costs and less access to green space all contribute to daily strain. That said, some people may feel less stressed than previous generations because of better healthcare and more flexible work options.",
      "Overall, stress can affect both mental and physical health. It may lead to anxiety, poor sleep, unhealthy eating habits and, over time, a higher risk of illness. Therefore, managing stress through outdoor activity, exercise and genuine rest is increasingly important.",
    ],
    languageFocus: [
      "From my perspective",
      "To begin with",
