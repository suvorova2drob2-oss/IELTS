...
export function checkVocabM8(input: string, answers: string[]): boolean {
  const n = normalize(input);
  if (!n) return false;
  return answers.some((a) => normalize(a) === n);
}

export const vocabularyM8 = {
  id: "vocabulary-m8-flow",
  bookPages: "p. 122 in your coursebook",
  sectionTitle: "Vocabulary · Community & communication",
  match1a: {
    badge: "1a",
