...
export function checkSpeakM8a(input: string, answers: string[]): boolean {
  const n = normalize(input);
  if (!n) return false;
  return answers.some((a) => normalize(a) === n);
}

export const speakingM8a = {
  id: "speaking-m8a-flow",
  bookPages: "p. 123 in your coursebook",
