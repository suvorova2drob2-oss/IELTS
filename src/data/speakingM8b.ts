...
export function checkSpeakM8b(input: string, answers: string[]): boolean {
  const n = normalize(input);
  if (!n) return false;
  return answers.some((a) => normalize(a) === n);
}

export const speakingM8b = {
  id: "speaking-m8b-flow",
  bookPages: "p. 129 in your coursebook",
