...
export function checkLangM8b(input: string, accepted: string[]): boolean {
  const n = normalize(input);
  if (!n) return false;
  return accepted.some((a) => normalize(a) === n);
}

export const languageM8b = {
  id: "language-m8b-flow",
  bookPages: "p. 128 in your coursebook",
  sectionTitle: "Language · Cause / effect linking; noun phrases",
